        ...
        <div className="mainContainer">
            ...
            <div className="bottom-side">
              <div className="ul">
                {headerCategory.map((item1, index1) => (
                  <div className="li mainLi" key={index1}>
                    <div
                      id="li"
          ...
          <nav>
            <div className="nav_contact">
              <div className="nav_contact_top">
                <div className="language-container">
                  <div className="container">
                    <div className="my-lan-select">
                      <div
                        className="lan-selected-item"
              ...
              <div className="nav_contact_bottom">
                ...
                <div
                  className="grid_box"
                  onClick={() =>
                    navigate("/596f5397-d116-4324-9196-b8a07f6ef884")
                  }
                >
                  {lang === "uz"
                    ? "Qabul "
